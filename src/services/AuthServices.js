...
export const registerUser = async (name, email, password, confirmPassword) => {
    try {
        const response = await axios.post(`https://chainforge-backend-q6bd.onrender.com/api/auth/register`, {
            name,
            email,
            password,
            confirmPassword,
...
export const loginUser = async (email, password) => {
    ...
    try {
        const response = await axios.post(`https://chainforge-backend-q6bd.onrender.com/api/auth/login`, {
            email,
            password,
        });
